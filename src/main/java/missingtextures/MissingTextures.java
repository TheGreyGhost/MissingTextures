...
/*
   ...
   public class StartupCommon {
    ...
    java.lang.NoClassDefFoundError: net/minecraft/client/renderer/tileentity/TileEntitySpecialRenderer
  	at missingtextures.CommonProxy.preInit(CommonProxy.java:25) ~[CommonProxy.class:?]
...
@Mod(modid = MissingTextures.MODID, version = MissingTextures.VERSION)
public class MissingTextures
{
    public static final String MODID = "missingtextures";
    public static final String VERSION = "1.0";

    // The instance of your mod that Forge uses.  Optional.
    @Mod.Instance(MissingTextures.MODID)
    public static MissingTextures instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide="missingtextures.ClientOnlyProxy", serverSide="missingtextures.DedicatedServerProxy")
     ...
     * @param name
     * @return eg "missingtextures:myblockname"
     */

...
public class StartupClientOnly
{
  ...
  {
    Item itemBlockSimple = GameRegistry.findItem("missingtextures", "mt17_blockname");
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("missingtextures:mt17_blockname", "inventory");

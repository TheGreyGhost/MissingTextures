package missingtextures.mbe01_block_simple;
...
public class StartupClientOnly
{
  ...
  public static void initClientOnly()
  {
    ...
    Item itemBlockSimple = GameRegistry.findItem("missingtextures", "mbe01_block_simple");
    ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("missingtextures:mbe01_block_simple", "inventory");

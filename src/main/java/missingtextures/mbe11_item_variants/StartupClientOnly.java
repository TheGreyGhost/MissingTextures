package missingtextures.mbe11_item_variants;
 ...
 public static void initClientOnly()
  {
    ...
    for (ItemVariants.EnumBottleFullness fullness : ItemVariants.EnumBottleFullness.values()) {
      ...
      ModelResourceLocation itemModelResourceLocation = new ModelResourceLocation("missingtextures:" + itemModelName, "inventory");
      // --> eg missingtextures:mbe11_item_variants_0pc, mbe11_item_variants_25pc, etc
